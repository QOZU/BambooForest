...
#[derive(Debug)]
pub struct BambooForestProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BambooForestProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BambooForest processing");
    
    let mut processor = BambooForestProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BambooForestProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BambooForestProcessor::new(false);
